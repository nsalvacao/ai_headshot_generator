...
const REMIX_SUGGESTIONS = [
  "Remix idea: Add background removal or replacement.",
  "Remix idea: Allow users to fine-tune results (e.g., smile more).",
  "Remix idea: Generate headshots in different art styles (e.g., cartoon).",
  "Remix idea: Create a batch generation feature for multiple styles at once.",
  "Remix idea: Add ability to download images in high resolution.",
  "Remix idea: Integrate 'super resolution' to enhance image quality.",
];
